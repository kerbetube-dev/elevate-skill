        ...
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              {tab.badge && tab.badge > 0 && !sidebarCollapsed && (
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <motion.aside
        ...
        className="hidden lg:block border-r bg-card h-screen sticky top-0 overflow-hidden"
      >
        <SidebarContent />
      </motion.aside>
        ...
        {mobileSidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              className="lg:hidden fixed left-0 top-0 h-full w-72 bg-card border-r z-50"
            >
          ...
          <div className="flex h-16 items-center gap-4 px-4 md:px-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="lg:hidden">
                <Avatar className="h-9 w-9 bg-gradient-primary cursor-pointer">
