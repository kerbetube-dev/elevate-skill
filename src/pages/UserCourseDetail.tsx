            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-500 to-purple-600 text-white">
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  className="w-full bg-white text-blue-600 hover:bg-gray-100 font-semibold py-3" size="lg">
                    <BookOpen className="w-5 h-5 mr-2" />
                    Enroll Now
                  </Button>
                  {/* <Button variant="outline" className="w-full border-white/30 text-white hover:bg-white/10 py-3">
