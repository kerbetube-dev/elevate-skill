#!/usr/bin/env python3
"""
Test script to debug Pydantic v2 field_validator
"""
...
def test_pydantic_v2_validation():
    """Test Pydantic v2 field_validator with different data types"""
    ...
    # Test with UUID object (should be converted to string)
    try:
        data2 = {
            "id": "test-id",
            "userId": "test-user-id",
