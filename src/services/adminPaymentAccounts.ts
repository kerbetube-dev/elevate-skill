...
class AdminPaymentAccountService {
   ...
   */
  async createPaymentAccount(data: CreatePaymentAccountData): Promise<PaymentAccount> {
    try {
      ...
      throw new Error(error.response?.data?.detail || 'Failed to create payment account');
    }
  }
  ...
  async updatePaymentAccount(
    ...
    try {
      ...
      throw new Error(error.response?.data?.detail || 'Failed to update payment account');
    }
  }
  ...
  async deletePaymentAccount(accountId: string): Promise<void> {
    try {
      ...
      throw new Error(error.response?.data?.detail || 'Failed to delete payment account');
    }
  }
   ...
   */
  async toggleAccountStatus(accountId: string, isActive: boolean): Promise<PaymentAccount> {
