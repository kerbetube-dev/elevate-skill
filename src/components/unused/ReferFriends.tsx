		...
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">
					Invite friends to join Elevate Skill and earn rewards for
					...
					<CardContent className="p-4">
						<div className="flex items-center space-x-2">
							...
							<div>
								...
								<p className="font-bold text-2xl">
									{referralStats?.totalEarnings || 0} ETB
								</p>
							</div>
						</div>
					</CardContent>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Share this code with friends to earn rewards when they
						sign up
					</CardDescription>
				</CardHeader>
				<CardContent>
							...
							>
								...
								<div className="text-right">
									...
									{referral.rewardEarned > 0 && (
										<p className="mt-1 font-semibold text-green-600 text-sm">
