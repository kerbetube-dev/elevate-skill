  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to Elevate Skill! Redirecting to dashboard...",
      });
    ...
    >
      ...
      >
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 h-11 ${
                touched.fullName && formData.fullName.length < 2 ? "border-destructive" : ""
              }`}
              disabled={loading}
            />
          </div>
        ...
        <motion.div variants={staggerItem} className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 h-11 ${
                touched.phoneNumber && !phoneValid ? "border-destructive" : ""
              }`}
              disabled={loading}
            />
          </div>
        ...
        <motion.div variants={staggerItem} className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 pr-10 h-11 ${
                touched.confirmPassword && !passwordsMatch ? "border-destructive" : ""
              }`}
              disabled={loading}
            />
            <button
            ...
            {touched.confirmPassword && passwordsMatch && (
              <CheckCircle className="absolute right-12 top-1/2 transform -translate-y-1/2 h-5 w-5 text-success-600" />
            )}
          </div>
          {touched.confirmPassword && !passwordsMatch && formData.confirmPassword.length > 0 && (
            <motion.p
        ...
        <motion.div variants={staggerItem} className="grid grid-cols-2 gap-4">
          <Button type="button" variant="outline" size="lg" className="h-11" disabled={loading}>
